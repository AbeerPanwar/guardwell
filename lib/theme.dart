...
class LightModeColors {
  static const lightPrimary = Colors.green; // Safety blue
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFE3F2FD);
  static const lightOnPrimaryContainer = Color(0xFF0D47A1);
  static const lightSecondary = Color(0xFF4CAF50); // Safety green
  static const lightOnSecondary = Color(0xFFFFFFFF);
  static const lightTertiary = Color(0xFFFF5722); // Emergency orange
  static const lightOnTertiary = Color(0xFFFFFFFF);
  static const lightError = Color(0xFFD32F2F); // Emergency red
  static const lightOnError = Color(0xFFFFFFFF);
  static const lightErrorContainer = Color(0xFFFFEBEE);
  static const lightOnErrorContainer = Color(0xFFB71C1C);
  static const lightInversePrimary = Colors.green;
  ...
  static const sosButtonColor = Color(0xFFD32F2F); // Emergency red for SOS
}

class DarkModeColors {
  static const darkPrimary = Color(0xFF90CAF9); // Light blue for dark mode
  ...
  static const sosButtonColor = Color(0xFFFF5252); // Emergency red for SOS
}
